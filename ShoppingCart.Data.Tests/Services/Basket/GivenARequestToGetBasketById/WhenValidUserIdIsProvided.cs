...
using GetBasketByIdResponse = ShoppingCart.Data.Services.Basket.GetBasketByIdResponse;

namespace ShoppingCart.Data.Tests.Services.Basket.GivenARequestToGetBasketById
{
    [TestFixture]
