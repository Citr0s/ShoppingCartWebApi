...
namespace ShoppingCart.Tests.Services.UserSession.GivenARequestToGetVoucherForUser
{
    [TestFixture]
    public class WhenTheUserIsFound
    {
        ...
        [Test]
        public void ThenTheSavedVoucherIsReturned()
        {
